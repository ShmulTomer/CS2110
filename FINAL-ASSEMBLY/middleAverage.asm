...
MIDDLE_AVERAGE 
    ...
    AND R0, R0, #0
    LDR R1, R5, #4 ;; R1 = array address
    LDR R2, R5, #5 ;; R2 = length 
    
    ADD R6, R6, #-1
    STR R2, R6, #0 ;; push length
    ...
    ADD R6, R6, #3 ;; popping two args + RV 
    ...
    ADD R4, R3, R2 ;; R4 = i - len + 2 

    BRzp FINISH

        LDR R1, R5, #4 ;; R1 = array address
        ADD R1, R1, R2 ;; add to the index
        LDR R1, R1, #0 ;; get the data at that index 
        ADD R0, R0, R1
    ...
    LDR R2, R5, #5 ;; R2 = length 
    ADD R2, R2, #-4 ;; R2 = length -4 

    ADD R6, R6, #-1
    STR R2, R6, #0 ;; push length -4 

    ADD R6, R6, #-1 
    STR R0, R6, #0 ;; push ans
